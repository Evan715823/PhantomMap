...
| `AI_ACKNOWLEDGMENT.md` | Per-syllabus AI-assistance disclosure |
...
- **Author 2** (teammate) — atlas visualisations, figures 1/3/5, related work, report §2–§3.

## Contact

- Author 1: `hu5@seas.upenn.edu`
- Author 2: `<teammate email>`
