...
drafting; every experimental choice, run, and figure in the submitted
version is our own. We thank the authors of POPE \cite{pope},
Qwen2.5-VL \cite{qwen25vl}, LLaVA-NeXT \cite{llavanext}, and EAZY
\cite{eazy} for making their code and data publicly available.
Author~1 wrote the evaluation code and ran all VLM experiments;
Author~2 built the atlas visualisations, produced the figures, and
wrote the related work.
